...
public class CreateStellaris
{
    ...
    public static class ClientModEvents
    {
        ...
        {
            // This tells Create that your helmet should show the goggle HUD
            //event.enqueueWork(() -> {
                //GogglesItem.addIsWearingPredicate(player ->
                        //player.getItemBySlot(EquipmentSlot.HEAD).is(Items.SPACE_HELMET_GOGGLES.get())
              //  );
            //});

            //LOGGER.info("Goggles functionality applied to Space Helmet.");
        }
    }
